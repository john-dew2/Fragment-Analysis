 ...
 *  File provides a variety of options that can be activated from command line arguments.
 *
 *  Author: Chris Alvin
...
bool Options::FREQUENCY_ANALYSIS = false;
bool Options::DISTRIBUTION_ANALYSIS = false;
bool Options::IS_SUBJECT_FILE = false;
